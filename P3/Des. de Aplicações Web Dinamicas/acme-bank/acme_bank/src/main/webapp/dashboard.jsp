...
<body class="dark-edition">
  ...
  <!-- Menu -->
    ...
    data-image="${pageContext.request.contextPath}/assets/img/sidebar-2.jpg">
      ...
      <ul class="dropdown-menu">
        ...
        <li>
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="${pageContext.request.contextPath}/assets/img/sidebar-1.jpg" alt="">
          </a>
        </li>
        <li class="active">
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="${pageContext.request.contextPath}/assets/img/sidebar-2.jpg" alt="">
          </a>
        </li>
        <li>
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="${pageContext.request.contextPath}/assets/img/sidebar-3.jpg" alt="">
          </a>
        </li>
        <li>
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="${pageContext.request.contextPath}/assets/img/sidebar-4.jpg" alt="">
          </a>
        </li>
