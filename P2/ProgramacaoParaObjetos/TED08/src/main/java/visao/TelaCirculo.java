...
public class TelaCirculo extends javax.swing.JFrame {
    ...
    public TelaCirculo(ArrayList<IFormaGeometrica> dados) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Tamanho do raio:");
    ...
    private void btCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCalcularActionPerformed
       ...
       limparTela();
       JOptionPane.showMessageDialog(null, "Área do circulo: " + circulo.calcularArea() + "\nPerímetro do circulo: " + circulo.calcularPerimetro());
       lista.add(circulo);
